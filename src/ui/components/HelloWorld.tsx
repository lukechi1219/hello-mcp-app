...
export function parseGreetingsFromResult(result: CallToolResult): Greeting[] | null {
...
export function HelloWorld({ app, toolResult, hostContext }: HelloWorldProps) {
  ...
  return (
    ...
    >
      ...
      <div class="version-badge">v3.0 — preact</div>
